...
Before upgrading Consul Enterprise servers to 1.11 or later, all Consul client and server agents should first
...
expecting local addresses, so a new [`X-Consul-Translate-Addresses`](/api-docs#translated-addresses)
